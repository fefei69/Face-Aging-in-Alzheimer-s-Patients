...
pred = []
err = []
df = pd.read_csv("C:/vscode/age_estimation_forlab/627fm_model.csv")
csv_filename = df["csv"].values
Models = df["model"].values
df1 = pd.read_csv("C:/vscode/age_estimation_forlab/patient_roundup.csv")
#df1 = pd.read_csv("C:/vscode/age_estimation_forlab/matched_pt_fm.csv")
...
fl.to_csv('C:/vscode/generate_csv/606/627flat_histo.csv')
